...
from deutschland.marktstammdaten import rest
...
from deutschland.marktstammdaten.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DatenApi()
        api_instance.einheit_einheit_json_get_erweiterte_oeffentliche_einheit_stromerzeugung_get  # this is an instance of the class Endpoint
        api_instance.einheit_einheit_json_get_erweiterte_oeffentliche_einheit_stromerzeugung_get()  # this invokes api_instance.einheit_einheit_json_get_erweiterte_oeffentliche_einheit_stromerzeugung_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.einheit_einheit_json_get_erweiterte_oeffentliche_einheit_stromerzeugung_get.callable or self.callable in this class
